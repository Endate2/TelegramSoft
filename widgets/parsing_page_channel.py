...
from ParsingTelegramChannelWorker import ParsingTelegramChannelWorker


class ParsingPageChannel(QWidget):
    def __init__(self):
        super().__init__()
        self.phone = None
        self.password = None
    ...
    def init_ui(self):
        ...
        title = QLabel("Парсинг @username из канала")
    ...
    def parse_messages(self):
        ...
        self.worker = ParsingTelegramChannelWorker("", self.phone, self.password)
